...
// This is a modified version of the original that supports binding using snake case.
...
namespace Microsoft.Extensions.Configuration
{
    ...
    public static class SnakeCaseConfigurationBinder
    {
        public static T Get<T>(this IConfiguration configuration, Action<SnakeCaseBinderOptions> configureOptions)
        {
        ...
        public static object Get(this IConfiguration configuration, Type type, Action<SnakeCaseBinderOptions> configureOptions)
        {
            if (configuration == null)
            {
                throw new ArgumentNullException(nameof(configuration));
            ...
            var options = new SnakeCaseBinderOptions();
            configureOptions?.Invoke(options);
            return BindInstance(type, instance: null, config: configuration, options: options);
        }

        public static void Bind(this IConfiguration configuration, object instance, Action<SnakeCaseBinderOptions> configureOptions)
        {
            if (configuration == null)
            {
                throw new ArgumentNullException(nameof(configuration));
        ...
        private static void BindNonScalar(this IConfiguration configuration, object instance, SnakeCaseBinderOptions options)
        {
            if (instance != null)
            {
        ...
        private static void BindProperty(PropertyInfo property, object instance, IConfiguration config, SnakeCaseBinderOptions options)
        {
            ...
            var propertyName = options.BindPropertiesUsingSnakeCaseNamingStrategy ? property.Name?.ToSnakeCase() : property.Name;
        ...
        private static object BindToCollection(TypeInfo typeInfo, IConfiguration config, SnakeCaseBinderOptions options)
        {
        ...
        private static object AttemptBindToCollectionInterfaces(Type type, IConfiguration config, SnakeCaseBinderOptions options)
        {
        ...
        private static object BindInstance(Type type, object instance, IConfiguration config, SnakeCaseBinderOptions options)
        {
        ...
        private static object CreateInstance(Type type)
        {
            ...
            if (typeInfo.IsInterface || typeInfo.IsAbstract)
            {
                throw new InvalidOperationException(
                    string.Format(CultureInfo.InvariantCulture, "Cannot create instance of type '{0}' because it is either abstract or an interface.", type));
            }
            ...
            if (type.IsArray)
            {
                ...
                {
                    throw new InvalidOperationException(
                        string.Format(CultureInfo.InvariantCulture, "Cannot create instance of type '{0}' because multidimensional arrays are not supported.", type));
                }
            ...
            {
                throw new InvalidOperationException(
                    string.Format(CultureInfo.InvariantCulture, "Cannot create instance of type '{0}' because it is missing a public parameterless constructor.", type));
            }
            ...
            {
                throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, "Failed to create instance of type '{0}'.", type), ex);
            }
        }

        private static void BindDictionary(object dictionary, Type dictionaryType, IConfiguration config, SnakeCaseBinderOptions options)
        {
        ...
        private static void BindCollection(object collection, Type collectionType, IConfiguration config, SnakeCaseBinderOptions options)
        {
        ...
        private static Array BindArray(Array source, IConfiguration config, SnakeCaseBinderOptions options)
        {
        ...
        private static bool TryConvertValue(Type type, string value, out object result, out Exception error)
        {
            ...
            if (converter.CanConvertFrom(typeof(string)))
            {
                ...
                {
                    error = new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, "Failed to convert '{0}' to type '{1}'.", value, type), ex);
                }
                return true;
            }
