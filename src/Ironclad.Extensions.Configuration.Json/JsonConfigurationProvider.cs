...
namespace Ironclad.Settings.Configuration.Json
{
    ...
    /// </summary>
    public class JsonXConfigurationProvider : FileConfigurationProvider
    {
        /// <summary>
        /// Initializes a new instance with the specified source.
        /// </summary>
        /// <param name="source">The source settings.</param>
        public JsonXConfigurationProvider(JsonXConfigurationSource source) : base(source) { }
        ...
        public override void Load(Stream stream)
        {
            try
            {
                Data = JsonXConfigurationFileParser.Parse(stream);
            }
